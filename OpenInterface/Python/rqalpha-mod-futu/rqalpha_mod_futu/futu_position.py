...
class FUTUStockPosition(BasePosition):
    ...
    def apply_trade(self, trade):
        ...
        if trade.side == SIDE.BUY:
            ...
            self._quantity += trade.last_quantity
            # isHK = 'HK.' in self._order_book_id
            # isUS = 'US.' in self._order_book_id
            # if not isHK and not isUS and self.stock_t1 and \
            #                 self._order_book_id not in {'510900.XSHG', '513030.XSHG', '513100.XSHG', '513500.XSHG'}:
    ...
    def sellable(self):
        ...
        return self._quantity - self._frozen
